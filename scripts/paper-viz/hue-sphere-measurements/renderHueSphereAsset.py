...
def main():
    ...
    if args.which_dir == 'q':
        ...
        ps.set_ground_plane_height_factor(0.7, False)
        ...
        rotation_mat = rotation_mat.T
        ps.set_ground_plane_height_factor(0.3, False)
    else:
        rotation_mat = np.eye(4)
    ...
    if args.which_dir == 'q':
        ps.look_at((position[0], position[1] * 0.77, -0.2), (0, 0, -0.2))
    elif args.which_dir == 'saq':
        ps.look_at((position[0], position[1] * 0.77, -0.1), (0, 0, -0.1))
    else:
        ps.look_at((position[0], 0.7, position[2] * 0.77), (0, 0.0, 0))  # not adjusting as expected
