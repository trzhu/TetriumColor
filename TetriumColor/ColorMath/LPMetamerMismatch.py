...
def GetMetamerMismatchBodyAtColor(response_functions1: npt.NDArray, response_functions2: npt.NDArray,
...
if __name__ == "__main__":
    ...
    vertices, spectras = GetMetamerMismatchBodyAtColor(observer1.normalized_sensor_matrix,
                                                       observer2.normalized_sensor_matrix, illuminant1, illuminant2, np.array([0.25, 0.25, 0.25]))

    print(vertices, spectras)
